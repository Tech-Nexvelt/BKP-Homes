...
export function CustomFurnitureWizard() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success('Archana furniture request created!');
    } catch (err: any) {
    ...
    <Card className="w-full max-w-3xl mx-auto p-6 md:p-8 bg-dark-card border-dark-border/80 shadow-gold relative overflow-hidden">
      ...
      {step <= 7 && (
        <div className="flex justify-between items-center border-b border-dark-border/60 pb-5 mb-8">
          <div>
            <span className="text-[10px] font-bold text-gold tracking-widest uppercase">Archana Configurator</span>
          ...
          {step === 7 && (
            ...
            >
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-muted-fg tracking-wide uppercase">Archana Design Requests & Notes</label>
                <textarea
          ...
          {step === 8 && (
            ...
            >
              ...
              <p className="text-xs text-muted-fg max-w-md mx-auto mt-2 leading-relaxed">
                Your Archana custom furniture design parameters have been logged. A dedicated Archana design staff from our Hyderabad studio will connect with you via email within 24 hours to finalize sketches and material discussions.
              </p>
              <Button
                variant="outline"
